...
/**
 * Thin HTTP adapter over ImportService. It only translates the request into
 * a connector instance and the result into flashed session data — the same
 * pipeline the console command runs.
 */
